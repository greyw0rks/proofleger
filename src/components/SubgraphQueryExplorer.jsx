// generated: may24  component: SubgraphQueryExplorer
// GraphQL query builder for protocol data
export default function SubgraphQueryExplorer({ data, onAction }) {
  if (!data) return null;
  return (
