// generated: may25  component: CredentialImportWizard
// multi-step credential import flow
export default function CredentialImportWizard({ data, onAction }) {
  if (!data) return null;
  return (
