// generated: may26  component: TimelockCountdownBar
// animated timelock unlock progress bar
export default function TimelockCountdownBar({ data, onAction }) {
  if (!data) return null;
  return (
