// generated: jun11  component: StakingV3ExtendedPanel
// extended v3 staking with boost tier
export default function StakingV3ExtendedPanel({ data, onAction }) {
  if (!data) return null;
  return (
