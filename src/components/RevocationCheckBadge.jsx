// generated: may26  component: RevocationCheckBadge
// real-time revocation status indicator
export default function RevocationCheckBadge({ data, onAction }) {
  if (!data) return null;
  return (
