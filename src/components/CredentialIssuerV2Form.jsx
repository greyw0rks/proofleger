// generated: jun9  component: CredentialIssuerV2Form
// v2 issuer credential issue form
export default function CredentialIssuerV2Form({ data, onAction }) {
  if (!data) return null;
  return (
