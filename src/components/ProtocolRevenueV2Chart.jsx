// generated: jun9  component: ProtocolRevenueV2Chart
// v2 revenue pie chart by category
export default function ProtocolRevenueV2Chart({ data, onAction }) {
  if (!data) return null;
  return (
