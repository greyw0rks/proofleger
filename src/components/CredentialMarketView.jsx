// generated: may28  component: CredentialMarketView
// marketplace overview with stats header
export default function CredentialMarketView({ data, onAction }) {
  if (!data) return null;
  return (
