// generated: jun8  component: GovernanceAnalyticsV2Panel
// v2 analytics with voter breakdown
export default function GovernanceAnalyticsV2Panel({ data, onAction }) {
  if (!data) return null;
  return (
