// generated: may25  component: StakingLeaderboardTable
// ranked staking table with position delta
export default function StakingLeaderboardTable({ data, onAction }) {
  if (!data) return null;
  return (
