// generated: jun7  component: GovernanceDelegateV2Form
// v2 delegation form with scope picker
export default function GovernanceDelegateV2Form({ data, onAction }) {
  if (!data) return null;
  return (
