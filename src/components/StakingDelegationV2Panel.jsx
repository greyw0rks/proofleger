// generated: jun10  component: StakingDelegationV2Panel
// v2 delegation panel with history
export default function StakingDelegationV2Panel({ data, onAction }) {
  if (!data) return null;
  return (
