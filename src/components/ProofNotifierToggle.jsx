// generated: may15  component: ProofNotifierToggle  desc: subscribe and unsubscribe proof event alerts
export default function ProofNotifierToggle({ data, onAction }) {
  if (!data) return null;
  return (
