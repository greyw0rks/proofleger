// generated: jun9  component: StakingRewardsV3Panel
// v3 rewards panel with auto-compound
export default function StakingRewardsV3Panel({ data, onAction }) {
  if (!data) return null;
  return (
