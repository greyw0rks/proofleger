// generated: jun9  component: ProofBatchStatusPanel
// batch job status grid with progress
export default function ProofBatchStatusPanel({ data, onAction }) {
  if (!data) return null;
  return (
