// generated: jun10  component: MarketplaceLiquidityV2Chart
// v2 liquidity depth chart
export default function MarketplaceLiquidityV2Chart({ data, onAction }) {
  if (!data) return null;
  return (
