// generated: jun6  component: OracleMultiAssetGrid
// multi-asset price grid with change
export default function OracleMultiAssetGrid({ data, onAction }) {
  if (!data) return null;
  return (
