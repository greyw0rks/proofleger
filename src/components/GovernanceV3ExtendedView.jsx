// generated: jun11  component: GovernanceV3ExtendedView
// extended v3 governance overview
export default function GovernanceV3ExtendedView({ data, onAction }) {
  if (!data) return null;
  return (
