// generated: may24  component: DelegationPowerMeter
// voting power bar with delegation stack
export default function DelegationPowerMeter({ data, onAction }) {
  if (!data) return null;
  return (
