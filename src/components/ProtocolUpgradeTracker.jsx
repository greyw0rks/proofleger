// generated: may28  component: ProtocolUpgradeTracker
// upgrade proposal tracker with timeline
export default function ProtocolUpgradeTracker({ data, onAction }) {
  if (!data) return null;
  return (
