// generated: may17  component: AchievementDetailModal  desc: achievement detail overlay with criteria
export default function AchievementDetailModal({ data, onAction }) {
  if (!data) return null;
  return (
