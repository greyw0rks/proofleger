// generated: jun10  component: OracleCircuitBreakerCard
// circuit breaker status with reset
export default function OracleCircuitBreakerCard({ data, onAction }) {
  if (!data) return null;
  return (
