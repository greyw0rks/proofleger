// generated: jun7  component: ProtocolUpgradeV2Tracker
// v2 upgrade proposal timeline
export default function ProtocolUpgradeV2Tracker({ data, onAction }) {
  if (!data) return null;
  return (
