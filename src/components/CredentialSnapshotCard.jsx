// generated: jun7  component: CredentialSnapshotCard
// snapshot card with delta indicators
export default function CredentialSnapshotCard({ data, onAction }) {
  if (!data) return null;
  return (
