// generated: may20  component: ProofRouterSuggestion  desc: suggested chain with cost comparison
export default function ProofRouterSuggestion({ data, onAction }) {
  if (!data) return null;
  return (
