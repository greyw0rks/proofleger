// generated: jun5  component: ProofAttestationList
// attestation list with issuer and type
export default function ProofAttestationList({ data, onAction }) {
  if (!data) return null;
  return (
