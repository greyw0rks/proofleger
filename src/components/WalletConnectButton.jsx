// generated: may17  component: WalletConnectButton  desc: connect and disconnect with address display
export default function WalletConnectButton({ data, onAction }) {
  if (!data) return null;
  return (
