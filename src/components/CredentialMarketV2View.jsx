// generated: jun10  component: CredentialMarketV2View
// v2 market view with bid and ask
export default function CredentialMarketV2View({ data, onAction }) {
  if (!data) return null;
  return (
