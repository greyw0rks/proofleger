// generated: jun6  component: ProtocolFeeHistoryChart
// fee history bar chart with breakdown
export default function ProtocolFeeHistoryChart({ data, onAction }) {
  if (!data) return null;
  return (
