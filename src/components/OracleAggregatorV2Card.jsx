// generated: jun9  component: OracleAggregatorV2Card
// v2 aggregated price with sources
export default function OracleAggregatorV2Card({ data, onAction }) {
  if (!data) return null;
  return (
