// generated: jun5  component: OracleThresholdPanel
// threshold config display with alerts
export default function OracleThresholdPanel({ data, onAction }) {
  if (!data) return null;
  return (
