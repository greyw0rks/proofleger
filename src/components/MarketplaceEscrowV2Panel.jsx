// generated: jun9  component: MarketplaceEscrowV2Panel
// v2 escrow panel with dispute flow
export default function MarketplaceEscrowV2Panel({ data, onAction }) {
  if (!data) return null;
  return (
