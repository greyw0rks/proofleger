// generated: jun11  component: OracleV3ExtendedCard
// extended v3 oracle with confidence
export default function OracleV3ExtendedCard({ data, onAction }) {
  if (!data) return null;
  return (
