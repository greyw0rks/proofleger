// generated: may27  component: CredentialBadgeDisplay
// badge grid with issuer and tier info
export default function CredentialBadgeDisplay({ data, onAction }) {
  if (!data) return null;
  return (
