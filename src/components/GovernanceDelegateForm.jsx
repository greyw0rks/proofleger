// generated: may28  component: GovernanceDelegateForm
// token delegation form with confirmation
export default function GovernanceDelegateForm({ data, onAction }) {
  if (!data) return null;
  return (
