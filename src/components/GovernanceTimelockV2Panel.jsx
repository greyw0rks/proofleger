// generated: jun10  component: GovernanceTimelockV2Panel
// v2 timelock queue with cancellation
export default function GovernanceTimelockV2Panel({ data, onAction }) {
  if (!data) return null;
  return (
