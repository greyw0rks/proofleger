// generated: jun5  component: GovernanceWeightMeter
// governance weight bar with breakdown
export default function GovernanceWeightMeter({ data, onAction }) {
  if (!data) return null;
  return (
