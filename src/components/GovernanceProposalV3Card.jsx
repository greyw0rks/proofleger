// generated: jun6  component: GovernanceProposalV3Card
// v3 proposal card with execution status
export default function GovernanceProposalV3Card({ data, onAction }) {
  if (!data) return null;
  return (
