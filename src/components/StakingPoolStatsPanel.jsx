// generated: jun8  component: StakingPoolStatsPanel
// pool stats with participant count
export default function StakingPoolStatsPanel({ data, onAction }) {
  if (!data) return null;
  return (
