// generated: may15  component: SubscriptionManager  desc: plan picker with upgrade and downgrade flow
export default function SubscriptionManager({ data, onAction }) {
  if (!data) return null;
  return (
