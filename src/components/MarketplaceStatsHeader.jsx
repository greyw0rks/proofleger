// generated: jun6  component: MarketplaceStatsHeader
// stats header with volume and count
export default function MarketplaceStatsHeader({ data, onAction }) {
  if (!data) return null;
  return (
