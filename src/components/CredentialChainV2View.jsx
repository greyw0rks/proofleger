// generated: jun6  component: CredentialChainV2View
// v2 chain view with depth indicator
export default function CredentialChainV2View({ data, onAction }) {
  if (!data) return null;
  return (
