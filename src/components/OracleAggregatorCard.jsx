// generated: may14  component: OracleAggregatorCard  desc: aggregated price with source count
export default function OracleAggregatorCard({ data, onAction }) {
  if (!data) return null;
  return (
