// generated: jun10  component: ProtocolGovernanceV3Dashboard
// v3 governance comprehensive dashboard
export default function ProtocolGovernanceV3Dashboard({ data, onAction }) {
  if (!data) return null;
  return (
