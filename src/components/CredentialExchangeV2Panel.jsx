// generated: jun11  component: CredentialExchangeV2Panel
// v2 exchange panel with offer matching
export default function CredentialExchangeV2Panel({ data, onAction }) {
  if (!data) return null;
  return (
