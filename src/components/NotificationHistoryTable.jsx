// generated: may20  component: NotificationHistoryTable  desc: paginated notification archive table
export default function NotificationHistoryTable({ data, onAction }) {
  if (!data) return null;
  return (
