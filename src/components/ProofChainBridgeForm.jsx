// generated: jun10  component: ProofChainBridgeForm
// chain bridge submission form
export default function ProofChainBridgeForm({ data, onAction }) {
  if (!data) return null;
  return (
