// generated: jun9  component: GovernanceVaultV2Card
// vault state card with lock status
export default function GovernanceVaultV2Card({ data, onAction }) {
  if (!data) return null;
  return (
