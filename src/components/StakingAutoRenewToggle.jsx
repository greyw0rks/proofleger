// generated: may27  component: StakingAutoRenewToggle
// auto-renew switch with cycle preview
export default function StakingAutoRenewToggle({ data, onAction }) {
  if (!data) return null;
  return (
